...
$config = include_once CONF.'sqlquery_config.php';
?>
<style>
	a{
...
<a href="./class/mysql_query.php?act=del" class="success">清空log日志文件</a>&nbsp;&nbsp;&nbsp;
<a href="./class/mysql_query.php?act=freshen<?php echo time();?>#end" class="success">刷新页面</a>
</div>
...
$url_path = 'localhost/phpgjx/mysql_query.php';
